                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                ...
                                @endif
                                <input type="text" class="form-control"  @if ( isset($id) ) readonly @endif  id="inputTag" name="tag" value="{{ $tag }}" placeholder="标签"></div>
                        </div>
                        <div class="form-group">
                            <label for="inputTitle" class="col-sm-2 control-label">标题</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="inputTitle" name="title" value="{{ $title }}" placeholder="标题"></div>
                        </div>
                        <div class="form-group">
                            <label for="inputImage" class="col-sm-2 control-label">图片</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="inputImage" name="page_image" value="{{ $page_image }}" placeholder=" 图片"></div>
                        </div>
                        <div class="form-group">
